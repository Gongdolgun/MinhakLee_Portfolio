...
ACPlayer::ACPlayer()
{
	...
	CHelpers::CreateActorComponent<UCSkillComponent>(this, &SkillComponent, "SkillComponent");
...
void ACPlayer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction<TDelegate<void(int)>>("QSkill", EInputEvent::IE_Pressed, SkillComponent, &UCWeaponComponent::UseSkill, ESkillIndex::0);
	PlayerInputComponent->BindAction<TDelegate<void(int)>>("WSkill", EInputEvent::IE_Pressed, SkillComponent, &UCWeaponComponent::UseSkill, ESkillIndex::1);
	PlayerInputComponent->BindAction<TDelegate<void(int)>>("ESkill", EInputEvent::IE_Pressed, SkillComponent, &UCWeaponComponent::UseSkill, ESkillIndex::2);
	PlayerInputComponent->BindAction<TDelegate<void(int)>>("ASkill", EInputEvent::IE_Pressed, SkillComponent, &UCWeaponComponent::UseSkill, ESkillIndex::3);
	PlayerInputComponent->BindAction<TDelegate<void(int)>>("SSkill", EInputEvent::IE_Pressed, SkillComponent, &UCWeaponComponent::UseSkill, ESkillIndex::4);
	PlayerInputComponent->BindAction<TDelegate<void(int)>>("DSkill", EInputEvent::IE_Pressed, SkillComponent, &UCWeaponComponent::UseSkill, ESkillIndex::5);
	PlayerInputComponent->BindAction<TDelegate<void(int)>>("VSkill", EInputEvent::IE_Pressed, SkillComponent, &UCWeaponComponent::UseSkill, ESkillIndex::6);
}

void ACPlayer::BaseAttack(AActor* InAttacker, cosnt FHitData& HitData)
{
	...
	{
		if (!!gameInstance)
			gameInstance->Player_HP = UKismetMathLibrary::Clamp(gameInstance->Player_HP - HitData->Damage, 0, gameInstance->Player_MaxHP);
	}
